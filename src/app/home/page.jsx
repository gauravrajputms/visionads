    ...
    <header className="fixed w-full z-30 bg-transparent">
      <nav className="max-w-7xl mx-auto flex items-center justify-between p-4 md:p-6">
        <div className="flex items-center gap-4">
          <Image src="./logo.jpg" alt="Vision Ads" width={48} height={48} className="rounded" />
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <a href="/contact" className="px-4 py-2 rounded-full bg-gradient-to-r from-teal-400 to-blue-600 text-white">Contact</a>
        </div>
      </nav>
    </header>
  );
...
/* ------------------ Portfolio ------------------ */
function Portfolio() {
  const items = ["logo.jpg","portfolio2.jpg","portfolio3.jpg","portfolio4.jpg"];
  return (
